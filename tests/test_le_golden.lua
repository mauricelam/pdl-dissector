...
function GroupConstraint_Struct_protocol_fields(fields, path)
    fields[path .. "._fixed_100_4"] = AlignedProtoField:new({
        name = "Fixed value",
        abbr = path .. "._fixed_100_4",
        ftype = ftypes.UINT16,
        bitlen = 16
    })
end
-- Sequence { name: "GroupConstraint_Struct", fields: [Scalar { display_name: "Fixed value", abbr: "_fixed_100_4", bit_offset: BitLen(0), ftype: FType(Some(BitLen(16))), len: Bounded { referenced_fields: [], constant_factor: BitLen(16) }, endian: LittleEndian, validate_expr: Some("value == 42") }], children: [], constraints: [] }
function GroupConstraint_Struct_dissect(buffer, pinfo, tree, fields, path)
    local i = 0
    local field_values = {}
    -- Scalar { display_name: "Fixed value", abbr: "_fixed_100_4", bit_offset: BitLen(0), ftype: FType(Some(BitLen(16))), len: Bounded { referenced_fields: [], constant_factor: BitLen(16) }, endian: LittleEndian, validate_expr: Some("value == 42") }
    local field_len = enforce_len_limit(sum_or_nil(16 / 8), buffer(i):len(), tree)
    field_values[path .. "._fixed_100_4"] = buffer(i, field_len):le_uint()
    local subtree = tree:add_le(fields[path .. "._fixed_100_4"].field, buffer(i, field_len))
    local value = field_values[path .. "._fixed_100_4"]
...
-- Sequence { name: "GroupConstraint_Packet", fields: [Typedef { name: "s", abbr: "s", decl: Sequence { name: "GroupConstraint_Struct", fields: [Scalar { display_name: "Fixed value", abbr: "_fixed_100_4", bit_offset: BitLen(0), ftype: FType(Some(BitLen(16))), len: Bounded { referenced_fields: [], constant_factor: BitLen(16) }, endian: LittleEndian, validate_expr: Some("value == 42") }], children: [], constraints: [] }, endian: LittleEndian }], children: [], constraints: [EnumMatch { field: "type", enum_type: "PacketType", enum_value: "GroupConstraint" }] }
function GroupConstraint_Packet_dissect(buffer, pinfo, tree, fields, path)
    local i = 0
    local field_values = {}
    -- Typedef { name: "s", abbr: "s", decl: Sequence { name: "GroupConstraint_Struct", fields: [Scalar { display_name: "Fixed value", abbr: "_fixed_100_4", bit_offset: BitLen(0), ftype: FType(Some(BitLen(16))), len: Bounded { referenced_fields: [], constant_factor: BitLen(16) }, endian: LittleEndian, validate_expr: Some("value == 42") }], children: [], constraints: [] }, endian: LittleEndian }
    local field_len = enforce_len_limit(sum_or_nil(16 / 8), buffer(i):len(), tree)
...
-- Sequence { name: "Fixed_Teapot", fields: [Scalar { display_name: "Fixed value", abbr: "_fixed_151_2", bit_offset: BitLen(0), ftype: FType(Some(BitLen(8))), len: Bounded { referenced_fields: [], constant_factor: BitLen(8) }, endian: LittleEndian, validate_expr: Some("value == 42") }, Scalar { display_name: "Fixed value: Empty", abbr: "_fixed_152_2", bit_offset: BitLen(0), ftype: FType(Some(BitLen(8))), len: Bounded { referenced_fields: [], constant_factor: BitLen(8) }, endian: LittleEndian, validate_expr: Some("Enum_CoffeeAddition_enum:match(\"Empty\", value)") }], children: [], constraints: [EnumMatch { field: "type", enum_type: "PacketType", enum_value: "Fixed" }] }
function Fixed_Teapot_dissect(buffer, pinfo, tree, fields, path)
    local i = 0
    local field_values = {}
    -- Scalar { display_name: "Fixed value", abbr: "_fixed_151_2", bit_offset: BitLen(0), ftype: FType(Some(BitLen(8))), len: Bounded { referenced_fields: [], constant_factor: BitLen(8) }, endian: LittleEndian, validate_expr: Some("value == 42") }
    local field_len = enforce_len_limit(sum_or_nil(8 / 8), buffer(i):len(), tree)
    ...
    i = i + field_len
    -- Scalar { display_name: "Fixed value: Empty", abbr: "_fixed_152_2", bit_offset: BitLen(0), ftype: FType(Some(BitLen(8))), len: Bounded { referenced_fields: [], constant_factor: BitLen(8) }, endian: LittleEndian, validate_expr: Some("Enum_CoffeeAddition_enum:match(\"Empty\", value)") }
    local field_len = enforce_len_limit(sum_or_nil(8 / 8), buffer(i):len(), tree)
...
function Padding_PaddedCoffee_dissect(buffer, pinfo, tree, fields, path)
    ...
    if i - initial_i < 10 then
        tree:add_expert_info(PI_MALFORMED, PI_WARN, "Error: Expected a minimum of 10 octets")
    end
    return i
end
