    ...
    pretty_assertions::assert_eq!(
        vec![
            ...
            vec![
                ...
                "  pot: 18",
                "  Size(additions): 3",
                "  Expert Info (Warning/Malformed): Error: Size(additions) is greater than the number of remaining bytes",
                "    Error: Size(additions) is greater than the number of remaining bytes",
                "    Message: Error: Size(additions) is greater than the number of remaining bytes",
                "    Severity level: Warning",
                "    Group: Malformed",
                "  additions: Alcoholic: Rum (11)",
                "  additions: Custom (24)",
