    ...
    pretty_assertions::assert_eq!(
        vec![
            ...
            vec![
                ...
                "  [_ws.lua.text] 001. .... = a: 1",
                "  [_ws.lua.text] ...0 0000 010. .... = b: 2",
                "  [_ws.lua.text] ...0 11.. = c: 3",
                "  [_ws.lua.text] .... ..10 0... .... = d: 4",
                "  [_ws.lua.text] .101 .... = e: 5",
            ...
            vec![
                ...
                "  [_ws.lua.text] 11.. .... = Size(Payload): 3",
                &format!(
                    "  [_ws.lua.text] ..00 0000 0100 0000 1000 0000 11.. .... = Payload: {}",
                    0x010203
                ),
            ...
            vec![
                ...
                "  [_ws.lua.text] 0000 0001 0000 0010 0000 .... = Reserved: 4128",
                "[_ws.expert] Expert Info (Warning/Malformed): Error: 4 undissected bits remaining",
                "  [_ws.lua.proto.warning] Error: 4 undissected bits remaining",
                "  [_ws.expert.message] Message: Error: 4 undissected bits remaining",
                "  [_ws.expert.severity] Severity level: Warning",
            ...
            vec![
                ...
                "  [_ws.lua.text] 1... .... = want_sugar: 1",
                "  [_ws.lua.text] .1.. .... = want_cream: 1",
                "  [_ws.lua.text] ..1. .... = want_alcohol: 1",
                "  [_ws.lua.text] ...0 0000 = Reserved: 0",
            ...
            vec![
                "[TopLevel.type] type: Optional (14)",
                "[_ws.lua.text] Optional_CoffeeWithAdditions",
                "  [_ws.lua.text] 0... .... = want_sugar: 0",
                "  [_ws.lua.text] .0.. .... = want_cream: 0",
                "  [_ws.lua.text] ..1. .... = want_alcohol: 1",
                "  [_ws.lua.text] ...0 0000 = Reserved: 0",
                "  [TopLevel.Optional_CoffeeWithAdditions.alcohol] alcohol: WHISKY (0)",
            ],
            ...
            vec![
                ...
                "  [_ws.lua.text] 001. .... = enum1: A (1)",
                "  [_ws.lua.text] ...0 10.. = enum2: B (2)",
                "  [_ws.lua.text] .... ..01 1... .... = enum3: C (3)",
